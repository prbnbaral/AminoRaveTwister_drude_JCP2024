...
class _OpenMMReadInputs():
    ...
    def __init__(self):
        ...
        self.fc_bbb           = 0.0                                       # Positional restraint force constant for protein backbone (kJ/mol/nm^2)
        self.fc_sc            = 0.0                                       # Positional restraint force constant for protein side-chain (kJ/mol/nm^2)
        self.fc_scc           = 0.0                                       # Positional restraint force constant for protein side-chain (kJ/mol/nm^2)
        ...
        for line in open(inputFile, 'r'):
            ...
            if len(line) > 0:
                ...
                if input_value:
                    ...
                    if input_param == 'DRUDE_TEMP':                     self.drude_temp       = float(input_value)
                    if input_param == 'DRUDE_FRIC_COEFF':               self.drude_fric_coeff = float(input_value)
                    if input_param == 'DRUDE_HARDWALL':                 self.drude_hardwall   = float(input_value)
                    ...
                    if input_param == 'FC_BBB':                         self.fc_bbb           = float(input_value)
                    if input_param == 'FC_POS':                         self.fc_pos           = float(input_value)
                    if input_param == 'FC_SC':                          self.fc_sc            = float(input_value)
                    if input_param == 'FC_SCC':                         self.fc_scc           = float(input_value)
